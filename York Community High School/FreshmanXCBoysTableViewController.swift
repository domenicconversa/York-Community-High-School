//
//  FreshmanXCBoysTableViewController.swift
...
class FreshmanXCBoysTableViewController: UITableViewController {

    var date = ["03/18/2017", "04/08/2017"]
    var team = ["vs. WSC Freshmen/JV Meet", "vs. Palatine and Jones Prep"]
    var time = ["9:00 AM", "3:00 PM"]
    var location = ["Field House", "Stadium"]
    var home = ["H", "H"]
